      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-1 mb-3">
                <a href="{{ route('moderator.post.create') }}" class="btn btn-primary">Добавить</a>
            </div>
            <div class="col-12">
            <div class="card">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr aria-expanded="false">
                        ...
                        <td class="text-center"><a href="{{ route('moderator.post.edit', $post->id) }}" class="text-success"><i class="fas fa-pencil-alt"></i></a></td>
                        <td class="text-center">
                            <form action="{{ route('moderator.post.delete', $post->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
